...
#include "unportable.h" // import flip endian
#include "utf8support.h"
#include "filestructwrapper.h"
...
private:
	...
	{
//		bool success = printInputFiles(pFile);	<-- WARNING UNUSED VARIABLE
